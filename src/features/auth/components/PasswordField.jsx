    ...
    <div className="grid gap-2 text-sm font-semibold text-espera-text">
      ...
      <div className="relative">
        <input
          ...
          className="min-h-12 w-full rounded-lg border border-espera-border bg-white px-4 pr-12 text-base font-normal text-espera-text outline-none transition placeholder:text-espera-text-muted/70 focus:border-espera-purple focus:ring-4 focus:ring-espera-purple-soft"
          id={inputId}

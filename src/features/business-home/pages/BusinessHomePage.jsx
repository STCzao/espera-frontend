import { BarChart3, Building2, CalendarClock, ListOrdered, QrCode, Settings2, UsersRound } from 'lucide-react'
...
const shortcuts = [
  ...
  },
  {
    to: 'queue/history',
    label: 'Historial',
    description: 'Consultá turnos completados y métricas por día.',
    icon: BarChart3,
  },
  {
    to: 'profile',
